...
#vapor pressure
#create the saturation VPD function
...
data_gila <- data_gila %>% mutate(prey_pres = (pp_mam + pp_rep + pp_gbird))
...
datatrim_gila <- dplyr::select(data_gila, c(site_id, tran_id, col_point, date, elev, avg_wind_spd, air_temp, act_vap_pres, gr_temp, rock_ind, abs_shr_dens, time_hms, det_strict, det_type_strict))
